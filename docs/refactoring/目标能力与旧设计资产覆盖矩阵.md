...
|---|---|---|---|---|
| Java build baseline | `RUNTIME_VERIFIED`（命令级） | `PARTIALLY_VALIDATED` | diagnosis 必须修复并通过干净 compile/test；examination 必须增加有效测试 | [构建基线](./evidence/phase-a/a1/java-build-baseline.md) |
