...
|---|---|---|---|
| `diagnosis-service` | dependency PASS；clean compile/test FAIL | `SPLIT + ADAPT` 保持候选；先解除 CDP/Agent API 与 Java 8 编译阻塞，不能按“可运行旧路径”处理 | [构建基线](./evidence/phase-a/a1/java-build-baseline.md) |
