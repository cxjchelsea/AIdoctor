...
| Safety / Question / Hypothesis / Knowledge | 空规则/空来源 + `REQUIRES_CLINICAL_REVIEW` + production/runtime `BLOCKED` | 不得直接 `APPROVED/ACTIVE`；旧规则仅可后续登记为 LEGACY_CANDIDATE | [缺口登记](./evidence/phase-a/a6/capability-review-gap-register.csv) |
