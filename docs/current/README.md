...
- 能力设计：V1 已冻结，见 `07_能力设计/按开发单元的Capability设计_V1.md`；
- 契约与数据：V1 已冻结，见 `08_契约与数据/Contract与数据语义设计_V1.md`；冻结前独立审查提出的 P8-R01～P8-R08 已全部 CLOSED；
- Runtime 与技术架构：V1 已冻结，见 `09_Runtime与技术架构/Runtime与技术架构设计_V1.md`；独立审查与复核提出的 P9-R01～P9-R07 已全部 CLOSED；
- 前端与交付：尚未开始。Phase 9 已冻结，当前已具备进入 Phase 10 设计阶段的前置条件，但尚未产生 Phase 10 设计或实现授权。
