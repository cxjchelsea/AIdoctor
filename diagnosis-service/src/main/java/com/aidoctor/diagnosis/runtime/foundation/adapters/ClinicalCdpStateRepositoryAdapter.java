package com.aidoctor.diagnosis.runtime.foundation.adapters;
...
/**
 * Infrastructure adapter that maps StateCommitter's repository port to the
 * authoritative CDP aggregate.
 *
 * <p>The mechanical StateCommitter package remains Spring/persistence-free.
 * This adapter is intentionally narrow: unsupported paths fail closed before
 * any CDP mutation, and structured values are never stringified to bypass the
 * current shared-contract boundary.</p>
 */
@Component
