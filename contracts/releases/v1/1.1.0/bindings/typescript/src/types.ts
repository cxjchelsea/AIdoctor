...
export type ObservationValue =
  ...
  | { kind: "CODED"; code: string; system: string; display?: string }
  | { kind: "QUANTITY"; value: number; unit: string }
  | { kind: "REFERENCE"; reference_type: string; reference_id: string };
...
export interface ClinicalStateSnapshot {
  ...
  committed_at: string;
  observations: Record<string, ClinicalObservation>;
  audit_ref?: AuditRef;
  trace_ref?: TraceRef;
  evidence_refs?: string[];
}
